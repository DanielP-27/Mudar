...
from server.views import(
    ...
    ProductoProduccionListView,
    ProductoProduccionDetalleView,
...
urlpatterns = [
    ...
    path('api/productos-produccion/', ProductoProduccionListView.as_view(), name='productos-produccion'),
    path('api/productos-produccion/<int:producto_id>/', ProductoProduccionDetalleView.as_view(), name='producto-produccion-detalle'),
